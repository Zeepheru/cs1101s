...
const full_drums = consecutively(
                        list(
                            full_drums_bar,
                            full_drums_bar,
                            full_drums_bar,
...
const melody = chorus(overlap_consec(rickroll_melody_soundlist));

const main = simultaneously(list(melody, full_drums));

const full = consecutively(list(intro, main));
